<?php
	...
	tie_build_theme_option(
		array(
			...
			'type'   => 'checkbox',
			'toggle' => '#reading_indicator_pos-item',
			'hint'   => '<span class="autoload-posts-features-notice-options tie-message-hint tie-message-error" style="padding-top: 2px; padding-bottom: 2px;">'. esc_html__( 'This feature can not be used while the Auto Load Posts option is active.', TIELABS_TEXTDOMAIN ) .'</span>'
		));
	
	tie_build_theme_option(
		array(
			'name'    => esc_html__( 'Reading Indicator Position', TIELABS_TEXTDOMAIN ),
			'id'      => 'reading_indicator_pos',
			'type'    => 'select',
			'options' => array(
				'bottom' => esc_html__( 'Bottom of the post', TIELABS_TEXTDOMAIN ),
				'top' => esc_html__( 'Top of the post', TIELABS_TEXTDOMAIN ),
			)
		));
	...
	tie_build_theme_option(
		array(
			'name' => esc_html__( 'Author Signature', TIELABS_TEXTDOMAIN ),
			'id'   => 'post_author_signature',
			'type' => 'checkbox',
		));
	...
	tie_build_theme_option(
		array(
			'name' => esc_html__( 'Copy Post Shortlink', TIELABS_TEXTDOMAIN ),
			'id'   => 'post_shortlink',
			'type' => 'checkbox',
		));
	...
	tie_build_theme_option(
		array(
			'name' => esc_html__( 'Auto Drop Caps the first letter of first paragraph', TIELABS_TEXTDOMAIN ),
			'id'   => 'post_auto_dropcap',
			'type' => 'checkbox',
		));
	...
	tie_build_theme_option(
		array(
			'title' => esc_html__( 'Post Author Box', TIELABS_TEXTDOMAIN ),
			'id'    => 'post-author-settings',
			'type'  => 'header',
		));
	...
	tie_build_theme_option(
		array(
			...
			'id'     => 'post_authorbio',
			'toggle' => '#post_authorbio_excerpt-item',
			'type'   => 'checkbox',
		));
	
	tie_build_theme_option(
		array(
			'name' => esc_html__( 'Post Author Bio Excerpt Length', TIELABS_TEXTDOMAIN ),
			'id'   => 'post_authorbio_excerpt',
			'type' => 'number',
		));
	...
	tie_build_theme_option(
		...
		echo '<div id="post_author_wrap-item">';
			...
			tie_build_theme_option(
				array(
					'name' => esc_html__( 'X Icon', TIELABS_TEXTDOMAIN ),
	...
	echo '<div id="words_per_min-item">';
		tie_build_theme_option(
			array(
				'name' => esc_html__( 'Words per minute', TIELABS_TEXTDOMAIN ),
				'id'   => 'words_per_min',
				'type' => 'number',
				'hint' => sprintf( esc_html__( 'Default is: %s', TIELABS_TEXTDOMAIN ), 250 ),
			));
	echo '</div>';
	...
	tie_build_theme_option(
		array(
			...
			'id'     => 'post_newsletter',
			'toggle' => '#post_newsletter_text-item, #post_newsletter_mailchimp-item',
			'type'   => 'checkbox',
		));
	...
	tie_build_theme_option(
		array(
			'title' => esc_html__( 'Google News and Flipboard', TIELABS_TEXTDOMAIN ),
			'id'  	=> 'post-google-news-flipboard',
			'type'	=> 'header',
		));
	...
	tie_build_theme_option(
		array(
			'name'   => esc_html__( 'Enable', TIELABS_TEXTDOMAIN ),
			'id'     => 'post_extra_follow_us',
			'toggle' => '#post_google_news_url-item, #post_flipboard_url-item, #post_extra_follow_us_title-item',
			'type'   => 'checkbox',
		));

		tie_build_theme_option(
			array(
				'name' => esc_html__( 'Show the Follow Us title', TIELABS_TEXTDOMAIN ),
				'id'   => 'post_extra_follow_us_title',
				'hint' => sprintf( esc_html__( 'You can change the "%s" text from the Translation tab.', TIELABS_TEXTDOMAIN ), esc_html__( 'Follow Us', TIELABS_TEXTDOMAIN ) ),
				'type' => 'checkbox',
			));
			
		tie_build_theme_option(
			array(
				'name' => esc_html__( 'Google News URL', TIELABS_TEXTDOMAIN ),
				'id'   => 'post_google_news_url',
				'type' => 'text',
			));

		tie_build_theme_option(
			array(
				'name' => esc_html__( 'Flipboard URL', TIELABS_TEXTDOMAIN ),
				'id'   => 'post_flipboard_url',
				'type' => 'text',
			));
	...
	echo '<div id="related-posts-options">';
		...
		tie_build_theme_option(
			array(
				...
				'id'      => 'related_order',
				'type'    => 'select',
				'options' => apply_filters( 'TieLabs/Options/Related/post_order_args', TIELABS_ADMIN_HELPER::get_orderby_list() ),
			));

		tie_build_theme_option(
			array(
				'name'    => esc_html__( 'Order', TIELABS_TEXTDOMAIN ),
				'id'      => 'related_asc_or_desc',
				'type'    => 'select',
				'options' => array(
	...
	echo '<div id="read-next-options">';
		...
		tie_build_theme_option(
			array(
				...
				'id'      => 'read_next_order',
				'type'    => 'select',
				'options' => apply_filters( 'TieLabs/Options/Read_Next/post_order_args', TIELABS_ADMIN_HELPER::get_orderby_list() ),
			));

		tie_build_theme_option(
			array(
				'name'    => esc_html__( 'Order', TIELABS_TEXTDOMAIN ),
				'id'      => 'read_next_asc_or_desc',
				'type'    => 'select',
				'options' => array(
					''    => esc_html__( 'Descending', TIELABS_TEXTDOMAIN ),
					'ASC' => esc_html__( 'Ascending', TIELABS_TEXTDOMAIN ),
	...
	tie_build_theme_option(
		array(
			...
			'id'     => 'check_also',
			'toggle' => '#check_also_position-item, #check_also_number-item, #check_also_query-item, #check_also_order-item, #check_also_asc_or_desc-item, #check_also_title_length-item',
			'type'   => 'checkbox',
		));
	...
	tie_build_theme_option(
		...
		array(
			...
			'id'      => 'check_also_order',
			'type'    => 'select',
			'options' => apply_filters( 'TieLabs/Options/Checkalso/post_order_args', TIELABS_ADMIN_HELPER::get_orderby_list() ),
		));

	tie_build_theme_option(
		array(
			'name'    => esc_html__( 'Order', TIELABS_TEXTDOMAIN ),
			'id'      => 'check_also_asc_or_desc',
			'type'    => 'select',
			'options' => array(
				''    => esc_html__( 'Descending', TIELABS_TEXTDOMAIN ),
				'ASC' => esc_html__( 'Ascending', TIELABS_TEXTDOMAIN ),
	...
	tie_build_theme_option(
		array(
			...
			'toggle' => '#inline_related_posts_paragraphs-item, #inline_related_posts_number-item, #inline_related_posts_query-item, #inline_related_posts_order-item, #inline_related_posts_asc_or_desc-item',
			'type'   => 'checkbox',
		));
	...
	tie_build_theme_option(
		array(
			...
			'type'    => 'select',
			'options' => apply_filters( 'TieLabs/Options/inline_related_post/post_order_args', TIELABS_ADMIN_HELPER::get_orderby_list() ),
		));

	tie_build_theme_option(
		array(
			'name'    => esc_html__( 'Order', TIELABS_TEXTDOMAIN ),
			'id'      => 'inline_related_posts_asc_or_desc',
			'type'    => 'select',
			'options' => array(
				''    => esc_html__( 'Descending', TIELABS_TEXTDOMAIN ),
				'ASC' => esc_html__( 'Ascending', TIELABS_TEXTDOMAIN ),
	...
	tie_build_theme_option(
		array(
			'title' => esc_html__( 'Comments Section', TIELABS_TEXTDOMAIN ),
			'id'    => 'comments-section',
			'type'  => 'header',
		));
	...
	tie_build_theme_option(
		array(
			'name'   => esc_html__( 'Disable the Website field', TIELABS_TEXTDOMAIN ),
			'id'     => 'comments_disable_url',
			'type'   => 'checkbox',
		));
