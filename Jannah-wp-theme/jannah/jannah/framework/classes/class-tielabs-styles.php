...
if( ! class_exists( 'TIELABS_STYLES' ) ) {
	...
	class TIELABS_STYLES {
		...
		public static function localize_script(){
			...
			// Check if the side aside has a Light Mode, Dark is the default
	  ...
	  */
		...
		public static function builder_section_style( $section ){
			...
			$section_margins[] = ! empty( $section_settings['margin_top'] )    ? 'margin-top:'.$section_settings['margin_top'].'px;'       : '';
			$section_margins[] = ! empty( $section_settings['margin_bottom'] ) ? 'margin-bottom:'.$section_settings['margin_bottom'].'px;' : '';
