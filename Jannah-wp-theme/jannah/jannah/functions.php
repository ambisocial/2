...
$token = 'e2eb9ef2-bc34-8ed2-39b4-ad59974c6f51';
update_option( 'tie_token_19659555', $token );
update_option( 'tie_jannah_custom_code', $token );
delete_option( 'tie_token_error_19659555' );
delete_transient( 'tie_server_error_19659555' );
/*
...
define( 'TIELABS_DB_VERSION', '7.6.5' );    // Don't change this
