...
require_once __DIR__ . '/editorial-staff.php';
...
require_once __DIR__ . '/seo-faq.php';
require_once __DIR__ . '/ymyl.php';
require_once __DIR__ . '/entity-pages.php';
require_once __DIR__ . '/network-hubs.php';
...
require_once __DIR__ . '/fonts-selfhosted.php';
require_once __DIR__ . '/home-layout.php';
require_once __DIR__ . '/single-article.php';
require_once __DIR__ . '/ticker-br.php';
require_once __DIR__ . '/newsletter-esp.php';
require_once __DIR__ . '/category-archive.php';
require_once __DIR__ . '/seo-yoast-defaults.php';
require_once __DIR__ . '/perf-consolidate-styles.php';
require_once __DIR__ . '/perf-lcp.php';
require_once __DIR__ . '/retention.php';
require_once __DIR__ . '/ops.php';
require_once __DIR__ . '/category-redirects.php';

define( 'ESTRATO_PORTAL_VERSION', '1.36.10' );
