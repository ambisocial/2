...
function estrato_single_styles() {
	...
	$css = 'body.single,body.single-post{overflow-x:clip}'
		. '.pg-main-col,.pg-entry-content{max-width:min(680px,100%)!important;width:100%!important;min-width:0;box-sizing:border-box;overflow-x:clip}'
		. '.pg-breadcrumbs,.pg-single-breadcrumbs,.pg-single-breadcrumb{display:none!important}'
		. '.estrato-single-breadcrumb-wrap{max-width:min(680px,100%);width:100%;margin:0 auto;padding:0 1rem;box-sizing:border-box;overflow-x:clip}'
		. '.estrato-single-breadcrumb-wrap .estrato-breadcrumb{margin:.35rem 0 .75rem;max-width:100%}'
		. '.estrato-single-header{max-width:min(680px,100%);width:100%;margin:0 auto var(--estrato-space-4);padding:0 1rem;box-sizing:border-box}'
		. '.estrato-single-dek{font-size:20px;line-height:1.45;color:var(--estrato-muted);margin:.75rem 0 1rem;overflow-wrap:anywhere}'
		...
		. '.entry-content,.post-content,.pg-entry-content{max-width:min(680px,100%);width:100%;margin:0 auto;font-size:18px;line-height:1.6;box-sizing:border-box;overflow-wrap:anywhere}'
		. '.entry-content img,.post-content img,.pg-entry-content img,.entry-content iframe,.post-content iframe,.pg-entry-content iframe,.entry-content video,.post-content video,.pg-entry-content video,.entry-content table,.post-content table,.pg-entry-content table,.entry-content pre,.post-content pre,.pg-entry-content pre{max-width:100%!important;height:auto}'
		. '.entry-content table,.post-content table,.pg-entry-content table{display:block;overflow-x:auto;-webkit-overflow-scrolling:touch}'
		. '.estrato-single-featured{margin:0 0 var(--estrato-space-4);max-width:min(680px,100%);width:100%}'
		...
		. '.estrato-single-related{max-width:min(680px,100%);width:100%;margin:var(--estrato-space-5) auto;padding:0 1rem;box-sizing:border-box}'
		. '.estrato-single-prevnext{max-width:min(680px,100%);width:100%;margin:var(--estrato-space-5) auto var(--estrato-space-4);padding:0 1rem;display:grid;gap:1rem;grid-template-columns:1fr;box-sizing:border-box}'
		. '@media(min-width:640px){.estrato-single-prevnext{grid-template-columns:1fr 1fr}}'
		. '.estrato-single-prev,.estrato-single-next{display:flex;flex-direction:column;gap:.25rem;padding:.85rem 1rem;border:1px solid var(--estrato-line);border-radius:6px;text-decoration:none;color:inherit;transition:border-color .15s;min-width:0}'
		...
		. '.estrato-single-prevnext__title{font-size:14px;font-weight:600;line-height:1.35;color:var(--estrato-ink);overflow-wrap:anywhere}'
		...
		. '.pg-single-content,.single-content,.pg-content-wrap,.content-area{width:100%!important;max-width:100%!important;float:none!important;min-width:0;box-sizing:border-box}'
